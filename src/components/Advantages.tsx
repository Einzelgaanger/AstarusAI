...
export const Advantages = () => {
  return (
    <motion.section
      className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-muted/20 overflow-hidden bg-shapes-soft"
      initial="hidden"
      animate="visible"
      whileInView="visible"
    ...
    >
      ...
      <div className="container relative z-10">
        ...
        <motion.div
          className="flex md:grid md:grid-cols-2 gap-5 sm:gap-6 max-w-5xl mx-auto overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-2 -mx-4 px-4 md:mx-auto md:px-0"
